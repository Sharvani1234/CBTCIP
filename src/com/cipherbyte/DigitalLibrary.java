...
public class DigitalLibrary {
	...
	public static void main(String[] args) {
		...
		library.addBook(new Book(1,"Book1","Author1","Fiction",2000));
		library.addBook(new Book(2,"Book2","Author2","Science",2010));
		library.addBook(new Book(3,"Book3","Author3","History",1995));
